        ...
        <div class="col-lg-4 col-md-12 mb-4">
          <div class="card h-100 shadow-lg">
            ...
            <div class="card-body text-center">
              <a href="{{ route('plants.checkout',$basic->plan_id) }}" class="btn btn-outline-primary btn-lg" style="border-radius:30px">Select</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-12 mb-4">
          <div class="card h-100 shadow-lg">
            ...
            <div class="card-body text-center">
            <a href="{{ route('plants.checkout',$professional->plan_id) }}" class="btn btn-outline-primary btn-lg" style="border-radius:30px">Select</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-12 mb-4">
          <div class="card h-100 shadow-lg">
            ...
            <div class="card-body text-center">
            <a href="{{ route('plants.checkout',$enterprise->plan_id) }}" class="btn btn-outline-primary btn-lg" style="border-radius:30px">Select</a>
            </div>
          </div>
        </div>
      </div>    
